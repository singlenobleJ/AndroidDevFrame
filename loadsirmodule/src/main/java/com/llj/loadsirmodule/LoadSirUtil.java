...
import com.llj.loadsirmodule.core.TargetContext;
...
public class LoadSirUtil {
    public static TargetContext getTargetContext(Object target) {
        ...
        if (oldContent == null) {
            throw new IllegalArgumentException(String.format("expected error when register LoadSir in %s", target
